...
public interface ContentCommon {
    ...
    public static final int GOSCAM_H264_STREAM = 10;
    ...
    public static final int PPPP_STATUS_USERORPASS_ERRER = 8;
    ...
    public static final int RES_HVGA = 8;
    public static final int RES_NHD = 4;
    public static final int RES_QQVGA = 2;
    public static final int RES_QVGA = 1;
    public static final int RES_UXGA_XVGA = 5;
    public static final int RES_VGA = 0;
    public static final int RES_WXGA = 3;
    public static final String SDCARD_PATH = "ZOOMX";
    public static final String SERVER_STRING = "SVTDEHAYLOSQTBHYPAARPCPFLKLQSTPNPDTAEIHUPLASEEPIPKAOSUPESXLXPHLUSQLVLSPALNLTLRLKLOLMLP-$$";
